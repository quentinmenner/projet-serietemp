...
a) Nous sommes d'abord demandés si la série avait une saisonnalité. Une façon de le voir est de regarder la répartition de l'indice pour chaque mois : 
...
Continuous tout de même la méthode de Box-Jenkins pour voir si notre hypothèse se vérifie.

Les graphiques de l'ACF et du PACF de la série stationnaire donnent comme valeur maximale des coeffecients AR et MA : 1.
